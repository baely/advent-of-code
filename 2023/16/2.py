...
starts: list[tuple[tuple, tuple]] = (
        [((x, -1), (0, 1)) for x in range(len(lines))] +
        [((x, len(lines[0])), (0, -1)) for x in range(len(lines))] +
        [((-1, x), (1, 0)) for x in range(len(lines[0]))] +
        [((len(lines), x), (-1, 0)) for x in range(len(lines[0]))])
